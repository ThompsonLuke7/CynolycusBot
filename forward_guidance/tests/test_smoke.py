"""Fixture smoke tests for forward_guidance.

Run with:
    python -m forward_guidance.tests.test_smoke
"""
...
from forward_guidance.data.discover_events import _parse_yfinance_earnings_dates, dedupe_events
from forward_guidance.data.sec_client import decompress_response_bytes
from forward_guidance.features.market_context import compute_forward_labels, compute_market_context
from forward_guidance.features.nlp import extract_forward_sections, extract_structured_guidance_features
from forward_guidance.models.train import walk_forward_splits
from forward_guidance.utils.dates import reaction_session
...
def run_all() -> None:
    ...
    print("forward_guidance smoke tests passed")
