...
from social_attention.config import DEFAULT_START, DEFAULT_SUBREDDITS, ensure_dirs
...
def main() -> int:
    ...
    if args.stage == "collect-reddit":
        ...
        from social_attention.reddit_collector import collect_reddit_history
        ...
        from social_attention.config import REDDIT_POSTS_PATH
        ...
        from social_attention.ticker_extractor import extract_mentions
        ...
        from social_attention.narrative_clustering import cluster_social_embeddings

        cluster_social_embeddings()
    elif args.stage == "narrative-features":
        from social_attention.narrative_clustering import build_narrative_features
        ...
        from social_attention.train_lightgbm import train_lightgbm
