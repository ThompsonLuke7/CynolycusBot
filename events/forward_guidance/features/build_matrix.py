...
from events.forward_guidance.config import (
    FEATURES_PATH,
    LABELS_PATH,
    TRAINING_MATRIX,
    ensure_data_dirs,
)
from events.forward_guidance.data.ingest_events import load_events, read_event_text
from events.forward_guidance.data.market_data import load_event_market_window
...
from events.forward_guidance.features.nlp import (
...
from events.forward_guidance.utils.io import flatten_dict, read_json, write_dataframe
...
def _metrics_for_event(event: EarningsEvent) -> dict[str, object]:
    from events.forward_guidance.config import RAW_DIR
    from events.forward_guidance.data.schema import raw_event_dir
