...
from signals.events.forward_guidance.utils.io import flatten_dict, read_json, write_dataframe
...
def _metrics_for_event(event: EarningsEvent) -> dict[str, object]:
    from signals.events.forward_guidance.config import RAW_DIR
    from signals.events.forward_guidance.data.schema import raw_event_dir
