...
from signals.catalysts.config import CATALYST_FEATURE_MATRIX_PATH
...
def main() -> int:
    ...
    if args.stage == "correlation-report":
        from signals.news.correlation_report import build_correlation_report
    ...
    if args.stage == "score-live":
        ...
        from signals.news.live_scoring import LiveScoringConfig, score_headline
