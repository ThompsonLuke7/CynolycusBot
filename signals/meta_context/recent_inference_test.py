...
MOM_FEATURES = REPO / "strategies/momentum_expansion/data/processed/features_4h.parquet"
...
def main():
    htf_feat = json.load(open(REPO / "strategies/multi_ticker_swing_htf/data/bundle/eval_metrics.json"))["feature_columns"]
    mom_feat = json.load(open(REPO / "strategies/momentum_expansion/data/training_import/bundle/eval_metrics.json"))["feature_columns"]
    ...
    run_ticker_model("momentum_expansion",
                     REPO / "strategies/momentum_expansion/data/training_import/bundle/expansion_xgb.json",
                     mom_feat, recent,
                     REPO / "strategies/momentum_expansion/plots/output/oof_eval", "Momentum expansion")
    print("=== multi_ticker_swing_htf ===")
    run_ticker_model("multi_ticker_swing_htf",
                     REPO / "strategies/multi_ticker_swing_htf/data/bundle/htf_swing_xgb.json",
                     htf_feat, recent,
                     REPO / "strategies/multi_ticker_swing_htf/plots/oof_eval", "HTF swing")
