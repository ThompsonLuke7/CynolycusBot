...
MODELS = [
    ...
    ModelSpec(
        ...
        bundle_dir=REPO / "strategies/multi_ticker_swing_htf/data/bundle",
        out_dir=REPO / "strategies/multi_ticker_swing_htf/plots/oof_eval",
    ...
    ModelSpec(
        ...
        bundle_dir=REPO / "strategies/momentum_expansion/data/training_import/bundle",
        out_dir=REPO / "strategies/momentum_expansion/plots/output/oof_eval",
        period_from_index=True,
        period_col=None,
...
def main():
    ...
    for spec in MODELS:
        ...
        try:
            ...
            print(f"  FAILED: {exc}")
            traceback.print_exc()
    with open(REPO / "signals/meta_context/oof_eval_summary.json", "w") as fh:
