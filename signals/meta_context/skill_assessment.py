...
OUT = REPO / "signals/meta_context/skill_assessment"
TOP_N = 10
...
MODELS = [
    M("momentum", REPO / "strategies/momentum_expansion/data/training_import/bundle/oof_preds.parquet",
      True, None, "fwd_close_return", False, 25, 252 / 10),
    M("htf_swing", REPO / "strategies/multi_ticker_swing_htf/data/bundle/oof_preds.parquet",
