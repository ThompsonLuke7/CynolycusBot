...
SPECS = [
    Spec(
        ...
        oof=REPO / "strategies/momentum_expansion/data/training_import/bundle/oof_preds.parquet",
    ...
    Spec(
        ...
        oof=REPO / "strategies/multi_ticker_swing_htf/data/bundle/oof_preds.parquet",
