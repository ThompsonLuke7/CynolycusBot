...
DEFAULT_MODEL_PATH = Path("signals/meta_context/models/news_catalyst_target_expansion_10pct_v3.xgb.json")
DEFAULT_TRAJECTORY_MODEL_PATH = Path("signals/meta_context/models/news_catalyst_trajectory_v3.xgb.json")
DEFAULT_MANIFEST_PATH = Path("signals/meta_context/data/processed/catalyst_training_manifest.json")
