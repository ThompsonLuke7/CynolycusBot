...
NEWS_RECORDS_PATH = REPO_ROOT / "news" / "data" / "processed" / "news_records.parquet"

# Yahoo Finance ticker profiles (from news module)
TICKER_PROFILES_PATH = REPO_ROOT / "news" / "data" / "processed" / "ticker_profiles.parquet"

# Per-ticker JSON profile cache (from legacy theme_expansion)
TICKER_PROFILES_CACHE_DIR = REPO_ROOT / "theme_expansion_legacy" / "data" / "ticker_profiles_cache"

# Forward guidance / events
EVENTS_FG_PATH = REPO_ROOT / "events" / "forward_guidance" / "data" / "processed"

# ── Output paths ─────────────────────────────────────────────────────────────
OUTPUTS_DIR = REPO_ROOT / "dynamic_theme" / "outputs"
