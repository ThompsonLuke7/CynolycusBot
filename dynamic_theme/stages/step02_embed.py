...
from dynamic_theme.config import BGE_MODEL, NEWS_RECORDS_PATH, TICKER_DOCUMENTS_PATH, TICKER_EMBEDDINGS_PATH, ensure_outputs

logger = logging.getLogger(__name__)

# Path to pre-computed per-article BGE embeddings from the news module
_NEWS_EMBEDDINGS_PATH = Path(__file__).resolve().parents[2] / "news" / "data" / "processed" / "news_embeddings.parquet"
