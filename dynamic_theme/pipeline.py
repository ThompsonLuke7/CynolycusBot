...
from dynamic_theme.config import ensure_outputs
from dynamic_theme.stages.step01_build_documents import build_ticker_documents
from dynamic_theme.stages.step02_embed import generate_embeddings
from dynamic_theme.stages.step03_cluster import cluster_tickers
from dynamic_theme.stages.step04_cluster_summary import build_cluster_summaries
from dynamic_theme.stages.step05_claude_labeling import label_clusters
from dynamic_theme.stages.step06_discovery import discover_new_themes
from dynamic_theme.stages.step07_relationships import build_relationship_graph
from dynamic_theme.stages.step08_memberships import compute_memberships
from dynamic_theme.stages.step09_meta_features import build_meta_features
...
def _get_tickers() -> list[str]:
    ...
    try:
        from dynamic_theme.config import REPO_ROOT
        import pandas as pd
        legacy = REPO_ROOT / "theme_expansion_legacy" / "data" / "theme_map_v4.csv"
        if legacy.exists():
