...
from strategies.spy_intraday.Models.meta_xgboost.train_entry import build_config as build_entry_config, run_entry_pipeline
from strategies.spy_intraday.Models.meta_xgboost.train_exit import run_exit_pipeline
...
def parse_args() -> argparse.Namespace:
    ...
    p.add_argument("--entry-max-holding-bars", type=int, default=8)
    ...
    p.add_argument("--entry-candidate-min-pivot-prob", type=float, default=None)
    p.add_argument("--entry-candidate-lookback-bars", type=int, default=0)
