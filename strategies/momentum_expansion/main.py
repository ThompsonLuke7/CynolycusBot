...
from strategies.momentum_expansion.labels.expansion_labels import (
    build_all_labels_4h,
...
def main() -> int:
    ...
    if args.export_colab:
        from strategies.momentum_expansion.models.export_for_colab import export_training_bundle
