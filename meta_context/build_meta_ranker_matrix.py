...
DYNAMIC_THEME_FEATURES = REPO / "dynamic_theme/outputs/ticker_theme_features.parquet"
...
def main():
    ...
    manifest = {
        ...
        "theme_context_source": "dynamic_theme/outputs/ticker_theme_features.parquet",
