...
from momentum_expansion.data.bars import fetch_context_bars, fetch_universe_bars
...
from multi_ticker_swing_htf.config import FEATURES_COMBINED, TRAIN_END, TRAIN_START
from multi_ticker_swing_htf.labels import build_all_labels_4h, build_training_matrix
from shared_universe.universe import build_shared_universe, load_shared_universe, shared_tickers, summarize_universe
...
def main() -> int:
    ...
    if args.audit_bars:
        ...
        out = Path("multi_ticker_swing_htf/data/processed/4h_bar_audit.csv")
