...
sys.path.insert(0, str(ROOT.parents[1]))  # repo root, for momentum_expansion import

import config as tcfg  # theme_expansion/config.py
from strategies.momentum_expansion.data.universe import get_candidate_pool
