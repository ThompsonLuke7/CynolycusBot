...
def run_fetch(args: argparse.Namespace) -> None:
    from multi_ticker_swing.config.pipeline_config import TRAIN_START, TRAIN_END, UNIVERSE_CSV
    from multi_ticker_swing.data.fetch_data import fetch_all
...
def run_features(args: argparse.Namespace) -> None:
    ...
    from multi_ticker_swing.features.build_features import build_all_features
...
def run_labels(args: argparse.Namespace) -> None:
    from multi_ticker_swing.config.pipeline_config import UNIVERSE_CSV
    from multi_ticker_swing.labels.build_labels import build_all_labels
...
def run_matrix(args: argparse.Namespace) -> None:
    from multi_ticker_swing.labels.build_labels import build_training_matrix
